...
this is a plain-text mirror of the live skill file, kept here so it's
browsable without opening the `.claude/` dotfolder. **not canonical** — if
this ever looks out of date, the real one wins:
`.claude/skills/delegate-to-kimi/SKILL.md`.

taken from commit `8330577` (2026-07-15).
